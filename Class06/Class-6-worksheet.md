...
```
## # A tibble: 1,704 x 6
##    conti country      year lifeExp      pop gdpPercap
##    <fct> <fct>       <int>   <dbl>    <int>     <dbl>
##  1 Asia  Afghanistan  1952    28.8  8425333      779.
##  2 Asia  Afghanistan  1957    30.3  9240934      821.
##  3 Asia  Afghanistan  1962    32.0 10267083      853.
...
```
## # A tibble: 1,704 x 6
##    country     conti  year lifeExp      pop gdpPercap
##    <fct>       <fct> <int>   <dbl>    <int>     <dbl>
...
##  2 Afghanistan Asia       1957    30.3  9240934      821.    7.58
...
```
## Warning in if (country == "Canada" & year == 1952) {: the condition has
